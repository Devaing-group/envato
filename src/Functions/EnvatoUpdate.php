...
namespace Devaing\Envato\Functions;
...
class EnvatoUpdate
{
    ...
    public static function reviewUrl()
    {
        ...
        $url = str_replace('verify-purchase', 'review', config('devaing_envato.verify_url'));
    ...
    {
        return DevaingApp::getRemoteData(config('devaing_envato.plugins_url'));
    }
    ...
    public static function updateVersionInfo()
    {
        ...
        try {
            ...
            $lastVersion = DevaingApp::getRemoteData(config('devaing_envato.updater_file_path'));
        ...
        try {
            ...
            $lastVersionLog = DevaingApp::getRemoteData(config('devaing_envato.versionLog') . '/' . File::get('version.txt'));
    ...
    public static function curl($postData)
    {
       ...
       try {
           $ch = curl_init();
           curl_setopt($ch, CURLOPT_URL, config('devaing_envato.verify_url'));
