...
namespace Devaing\Envato\Controllers;

use App\Helper\Reply;
use App\Http\Controllers\Controller;
use Devaing\Envato\Functions\EnvatoUpdate;
use Devaing\Envato\Helpers\DevaingApp;
...
class UpdateScriptVersionController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $setting = config('devaing_envato.setting');
    ...
    {
        return config('devaing_envato.allow_users_id');
    }
    ...
    public function updateDatabase()
    {
        ...
        return 'Database updated successfully. <a href="' . route(config('devaing_envato.redirectRoute')) . '">Click here to Login</a>';
    }
    ...
    public function clearCache(): array|string
    {
        ...
        return 'Cache cleared successfully. <a href="' . route(config('devaing_envato.redirectRoute')) . '">Click here to Login</a>';
    }
    ...
    public function refreshCache()
    {
        ...
        return 'Cache refreshed successfully. <a href="' . route(config('devaing_envato.redirectRoute')) . '">Click here to Login</a>';
    }
    ...
    */
    public function update($module = null)
    {
        ...
        try {
            ...
            $filename_tmp = config('devaing_envato.tmp_path') . '/' . $update_name;
    ...
    public function install($module = null)
    {
        ...
        try {
            ...
            $update_path = config('devaing_envato.tmp_path') . '/' . $archive;
    ...
    */
    ...
    {
        $url = config('devaing_envato.updater_file_path');

        if ($module) {
            $url = $this->replaceWithModuleProductName($module, $url);
        }

        return DevaingApp::getRemoteData($url);
    }
    ...
    */
    ...
    private function getLastVersionFileUrl($module = null)
    {
        ...
        $url = config('devaing_envato.latest_version_file') . '/' . $this->appSetting->purchase_code . '/' . $archive;
    ...
    public function checkSupport($module = null)
    {
        ...
        $link = 'https://support.devaing.net/';
    ...
    {
        $appIemId = config('devaing_envato.envato_item_id');
    ...
    {
        $appProductName = config('devaing_envato.envato_product_name');
