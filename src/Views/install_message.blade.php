<html>
<head>
    <title>{{ ucwords(config('devaing_envato.envato_product_name'))}} Not installed</title>
    <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">
    <link rel="stylesheet" href="../../laravel-installer/assets/devaing-helper/helper.css">
...
<div class="container">
    <div class="row" style="margin-top: 30px">
        ...
        <div class="bs-example" data-example-id="alerts-with-links" style="margin-top:10px ">
            ...
            <div class="alert alert-warning" role="alert"><strong>{{ ucwords(config('devaing_envato.envato_product_name'))}} not installed!</strong> Visit <a
                    href="{{ url('/install')}}"
