@php($envatoUpdateCompanySetting = \Devaing\Envato\Functions\EnvatoUpdate::companySetting())
        ...
        @if(\Carbon\Carbon::parse($envatoUpdateCompanySetting->supported_until)->isPast())
            <div class="col-md-12 alert alert-danger ">
                ...
                <div class="col-md-6 text-right">
                    <a href="{{ config('devaing_envato.envato_product_url') }}" target="_blank"
...
@php($updateVersionInfo = \Devaing\Envato\Functions\EnvatoUpdate::updateVersionInfo())
